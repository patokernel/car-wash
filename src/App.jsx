    ...
    <div className="App">
      ...
      <div className='services'>
        ...
        <Services
          videoSrc={ducha}
          title={'DUCHA'}
          subtitle={'El lavado con agua a presión tiene ventajas: el agua alcanza los rincones difíciles, ahorro de tiempo y consumo de agua reducido, la suciedad de la carrocería se remueve fácilmente evitando que la pintura se raye por desechos como arena o barro.'}
          flipped={false}
        />
        <Services
          videoSrc={aspirado}
        ...
        <Services
          ...
          subtitle={'Con las butacas puestas, realizamos el proceso manual con cepillos y apc para eliminar manchas de todo tipo. Luego con la máquina de lavatapizados y su sistema de inyección y extracción cerramos el proceso dejando las butacas con una terminación nueva, super limpias y desinfectadas.'}
          flipped={false}
        />
        <Services
